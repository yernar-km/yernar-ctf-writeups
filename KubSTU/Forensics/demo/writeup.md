...
Защита на каждом уровне: параметризованные запросы (против SQLi), минимальные привилегии MySQL (без `FILE`), хранение конфигов вне веб-корня, MFA на SSH, мониторинг аномального поведения по логам.