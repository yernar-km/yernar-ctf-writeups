...
Exploitation Steps
    ...
    Curve Identification: It was experimentally determined (by verifying the public key parameters) that the server uses the secp256k1 curve

    Collision Collection: Signatures were collected for sequential messages (01, 02, 03...) until a duplicate r was encountered

    Key Recovery: Using the formulas above, the secret key d was calculated

    Forge: A valid signature for give_me_flag was generated using a custom k=1
